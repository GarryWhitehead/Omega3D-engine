...
public:
	...
	void LoadTexture(std::string filename, const VkSamplerAddressMode addrMode, float maxAnisotropy, const VkBorderColor color, const VkFormat format, const VkCommandPool cmdPool, VulkanEngine *p_vkEngine);
	void LoadTextureArray(std::string filename, VkSamplerAddressMode addrMode, float maxAnisotropy, const VkBorderColor color, const VkFormat format, const VkCommandPool cmdPool, VulkanEngine *p_vkEngine);
	void LoadCubeMap(std::string filename, const VkFormat format, const VkCommandPool cmdPool, VulkanEngine *p_vkEngine);
