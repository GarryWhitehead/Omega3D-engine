...
public:
	...
	void Destroy();
	void PrepareImage(const VkFormat f, const VkSamplerAddressMode samplerMode, const VkImageUsageFlags usageFlags, uint32_t w, uint32_t h, float maxAnisotropy = 1.0f, bool createSampler = true);
	...
	void CreateTextureSampler(const VkSamplerAddressMode addressMode, float maxAnisotropy, const VkBorderColor borderColor);
