...
void Sampler::create(vk::Device dev, SamplerType type)
{
	...
	case SamplerType::Clamp:
		createSampler(vk::SamplerAddressMode::eClampToEdge, vk::Filter::eNearest,
		              vk::SamplerMipmapMode::eNearest, false);
		break;
	case SamplerType::Wrap:
		createSampler(vk::SamplerAddressMode::eRepeat, vk::Filter::eNearest,
		              vk::SamplerMipmapMode::eNearest, false);
		break;
	case SamplerType::LinearClamp:
		createSampler(vk::SamplerAddressMode::eClampToEdge, vk::Filter::eLinear,
		              vk::SamplerMipmapMode::eNearest, false);
		break;
	...
	case SamplerType::LinearWrap:
		createSampler(vk::SamplerAddressMode::eRepeat, vk::Filter::eLinear,
		              vk::SamplerMipmapMode::eNearest, false);
		break;
...
void Sampler::createSampler(vk::SamplerAddressMode addressMode, vk::Filter filter,
                            vk::SamplerMipmapMode mipMapMode, bool compareOp)
{
	vk::SamplerCreateInfo samplerInfo(
	    {}, filter, filter, mipMapMode, addressMode, addressMode, addressMode, 0.0f, VK_TRUE,
