...
namespace OmegaEngine
{
	...
	public:
		...
		void extractGltfModelAssets(std::unique_ptr<GltfModel::Model>& model, uint32_t& materialOffset, uint32_t& skinOffset, uint32_t& animationOffset);
		...
		GroupedHandle createGroupedGltfModelObject(std::unique_ptr<GltfModel::Model>& model, 
													bool useMaterial, 
